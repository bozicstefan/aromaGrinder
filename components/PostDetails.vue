...
<template>
  <section class="bg-amber-50 p-6 sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60%] mx-auto rounded-lg shadow-lg my-20 ">
    <article>
      ...
      <section v-html="postDetails.content" class="post-content text-amber-900 space-y-4 border-b border-amber-200"></section>
    ...
    <div
      class="mt-8  pt-4 flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center"
    >
      <NuxtLink to="/blog">
        <button
